        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="/assets/img/vale-logo.png" width="110" height="32" alt="Vale" class="navbar-brand-image">
                    </a>
                </h1>
        ...
        <header class="navbar-expand-md">
            <div class="collapse navbar-collapse" id="navbar-menu">
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            <li class="nav-item <?= $_SERVER['REQUEST_URI'] == '/admin/dashboard.php' ? 'active' : '' ?>">
                            ...
                            <li class="nav-item <?= $_SERVER['REQUEST_URI'] == '/admin/services.php' ? 'active' : '' ?>">
                            ...
                            <li class="nav-item <?= $_SERVER['REQUEST_URI'] == '/admin/projects.php' ? 'active' : '' ?>">
                            ...
                            <li class="nav-item <?= $_SERVER['REQUEST_URI'] == '/admin/blogs.php' ? 'active' : '' ?>">
